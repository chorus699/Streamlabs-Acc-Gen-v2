...
class Console:
    ...
    def purchased(self, message, obj=""):
        print(f"{self.colors['lightblack']}{self.timestamp()} » {self.colors['lightmagenta']}PURCHASED {self.colors['lightblack']}➜ {self.colors['white']}{message} [{self.colors['lightgreen']}{obj}{self.colors['white']}] {self.colors['reset']}")

    def promo(self, message, obj=""):
        print(f"{self.colors['lightblack']}{self.timestamp()} » {self.colors['lightmagenta']}FETCHED PROMO {self.colors['lightblack']}➜ {self.colors['white']}{message} [{self.colors['lightgreen']}{obj}{self.colors['white']}] {self.colors['reset']}")
